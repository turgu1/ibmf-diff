...
struct Dim {
  ...
  auto operator==(const Dim &other) const -> bool {
...
struct Pos {
  ...
  Pos() : x(0), y(0) {}
  auto operator==(const Pos &other) const -> bool { return (x == other.x) && (y == other.y); }
};
...
struct Bitmap {
  ...
  auto operator==(const Bitmap &other) const -> bool {
...
struct FaceHeader {
  ...
  auto     operator==(FaceHeader &other) const -> bool {
        return (pointSize == other.pointSize) && (lineHeight == other.lineHeight) &&
               (dpi == other.dpi) && (xHeight == other.xHeight) && (emSize == other.emSize) &&
               (slantCorrection == other.slantCorrection) &&
               (descenderHeight == other.descenderHeight) && (spaceSize == other.spaceSize) &&
               (glyphCount == other.glyphCount) && (ligKernStepCount == other.ligKernStepCount) &&
               (pixelsPoolSize == other.pixelsPoolSize);
  }
};
...
struct RLEMetrics {
  ...
  //
  auto operator==(const RLEMetrics &other) const -> bool {
...
struct GlyphInfo {
  ...
  //
  auto operator==(const GlyphInfo &other) const -> bool {
...
struct BackupGlyphInfo {
  ...
  //
  auto operator==(const BackupGlyphInfo &other) const -> bool {
    return (bitmapWidth == other.bitmapWidth) && (bitmapHeight == other.bitmapHeight) &&
           (horizontalOffset == other.horizontalOffset) &&
           (verticalOffset == other.verticalOffset) && (packetLength == other.packetLength) &&
           (advance == other.advance) && (rleMetrics == other.rleMetrics) &&
           (mainCodePoint == other.mainCodePoint) && (codePoint == other.codePoint);
  }
};
...
struct GlyphKernStep {
  ...
  FIX16    kern;
  //
  auto operator==(const GlyphKernStep &other) const -> bool {
...
struct GlyphLigStep {
  ...
  //
  auto operator==(const GlyphLigStep &other) const -> bool {
...
struct GlyphLigKern {
  ...
  //
  auto operator==(const GlyphLigKern &other) const -> bool {
